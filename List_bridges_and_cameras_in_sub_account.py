...
###
    ...
    bridge_id_list = [{'id': i[1], 'guid': i[8], 'serial_number': i[9] } for i in device_list if i[3] == 'bridge' and i[15] == 0]
    camera_id_list = [{'id': i[1] } for i in device_list if i[3] == 'camera' and i[5] == 'ATTD' and i[15] == 0]

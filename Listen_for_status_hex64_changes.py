...
for d in camera_id_list:
    register_msg['cameras'][d] = { 'resource': ['status_hex64'] }
...
while True:
    ...
    for device_id, device_data in jdata['data'].items():
        ret = parseStatusHex(device_data['status_hex64'])
        print(CLI_STATUS_STRING.format(device_id, device_data['status_hex64'], ret))

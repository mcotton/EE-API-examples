...
sub_account_id_list = [(i[0], i[1]) for i in sub_account_list if i[0] == '00029025']
...
for sub in sub_account_id_list:
    ...
    print("Step 3.1: %s" % HTTP_STATUS_CODE[response.status_code])
...
print("Step 3.2: %s" % HTTP_STATUS_CODE[response.status_code])
...
print(auth_key)
print(account_id)
print('wss://login.eagleeyenetworks.com/api/v2/Device/{}/Events'.format(account_id))
print('cookie=auth_key={}'.format(auth_key))
print(len(camera_id_list))
